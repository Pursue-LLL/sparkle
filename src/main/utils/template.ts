...
export const defaultConfig: AppConfig = {
  ...
  cursorConnectionHygieneEnabled: true,
  proxySwitchPriority: ['新加坡', '日本', '台湾', '韩国', '美国'],
  proxyHealthCheckInterval: 60,
  proxyTimeoutThreshold: 5000,
  networkAlertEnabled: true,
  networkAlertDelayThresholdMs: 800,
  networkAlertProbeLatencyThresholdMs: 2000,
  networkAlertConsecutiveHits: 2,
  networkAlertCooldownMs: 15 * 60_000,
  commercialNodeBenchmarkEnabled: false,
  commercialNodeBenchmarkIntervalSec: 60,
  commercialNodeBenchmarkReportIntervalSec: 3600,
  commercialNodeBenchmarkConcurrency: 3,
  commercialNodeBenchmarkRegions: ['新加坡', '日本', '台湾', '韩国', '美国'],
  commercialNodeBenchmarkNotifyOnReport: true,
  commercialNodeBenchmarkReportDir: '',
  commercialNodeBenchmarkIncludeVps: true,
