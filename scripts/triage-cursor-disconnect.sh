...
write_quic_stall_signals_at_a() {
  ...
  rg 'MihomoQuicSilentStall|frozen_quic_cursor|mihomo_quic_silent_stall|token_gap_rescue_ineffective|connect_partition_rescue_ineffective|ConnectPartitionRescueIneffective|MarathonProtocolContract|marathon_transport_preflight|MarathonContentionBudget' \
